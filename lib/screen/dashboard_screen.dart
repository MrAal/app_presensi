...
import 'package:app_presensi/model/presensi.dart';
import 'package:app_presensi/screen/attandance_recap_screen.dart';
import 'package:app_presensi/screen/log_activity_screen/logs_home_screen.dart';
import 'package:app_presensi/utils/mix.dart';
            ...
            ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  const Icon(
                    Icons
                        .note_add_outlined, // This is the icon you want before the text
                    color: Colors.white, // Icon color
                    size: 24.0, // Icon size
                  ),
                  const SizedBox(width: 8), // Spacing between icon and text
